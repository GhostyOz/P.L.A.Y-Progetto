...
public class TrovaErrore2Controller {
    ...
    protected void invioRisposta(ActionEvent e) throws Exception {
        ...
        // Se la risposta giusta (R3) è selezionata, visualizza "RISPOSTA ESATTA"
        if (R3.isSelected())
            label.setText("RISPOSTA ESATTA"); 
        // Se una risposta errata (R1, R2, R4) è selezionata, mostra il tipo di errore
    ...
    protected void SalvaEdEsci(ActionEvent e) throws Exception {
        ...
        // Se la risposta giusta (R3) è selezionata
        if (R3.isSelected()) {
    ...
    protected void SalvaEContinua(ActionEvent e) throws Exception {
        ...
        // Se la risposta giusta (R3) è selezionata e la risposta è stata inviata
        if (R3.isSelected() && checkInvio == true) {
            // Aggiunge gli utenti dal file "utenti.txt"
            while (scf.hasNextLine()) {
                String s = scf.nextLine();
                String[] S = s.split(" ");
            ...
            pwBar.close();  // Chiude il file della ProgressBar
            App.increaseProgress();  // Incrementa il progresso dell'utente
            App.setRoot("trova_errore3");  // Passa al prossimo livello
        }
